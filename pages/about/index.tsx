...
export default function About() {
  return (
    <div className=" flex min-h-screen w-full flex-col items-center justify-around px-12">
      <h1
        className=" text-3xl
      "
      >
      ...
      <section>
        ...
        <p className="px-2">{`As with any large language model, it's possible for ai generated responses to be inaccurate or unreliable. It's recommended to fact check important information.`}</p>
        <p className="px-2">
          {`Though I've given my chat bot information about myself and my skills, I simply can't guarantee accuracy. It may decide to make something up, like that my birthday is in April or I'm a PHP expert. If you'd like to know more about me or my skills, you can check out `}
          <a
            target="_blank"
